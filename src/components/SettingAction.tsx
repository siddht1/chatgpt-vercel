    ...
    >
      <Show when={shown()}>
        <div class="<sm:max-h-10em max-h-14em overflow-y-auto">
          ...
          <SettingItem icon="i-carbon:data-enrichment" label="The degree of divergence of thinking">
            <input
              type="range"
              min={0}
              max={100}
          ...
          <SettingItem
            ...
            label="Record the conversation, refresh will not disappear"
          >
          ...
          <SettingItem
            ...
            label="Start a continuous conversation, which will double the cost Token"
          >
            <label class="relative inline-flex items-center cursor-pointer ml-1">
              <input
                type="checkbox"
